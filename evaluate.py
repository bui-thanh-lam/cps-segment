...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config", type=str, default="segformer_b1")
    parser.add_argument("--use_cutmix", type=bool, default=False)
    # parser.add_argument("--checkpoint_path", type=str, default=None)
    parser.add_argument("--checkpoint_path", type=str, default="../checkpoints/50/segformer/segformer_b1_50")
