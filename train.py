...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_epochs", type=int, default=15, help="Num epochs to train")
    ...
    parser.add_argument("--labelled_image_dir", type=str, default="../datasets/SemiDataset12/labelled/image")
    parser.add_argument("--unlabelled_image_dir", type=str, default="../datasets/SemiDataset12/unlabelled/image")
    parser.add_argument("--mask_dir", type=str, default="../datasets/SemiDataset12/labelled/mask")
